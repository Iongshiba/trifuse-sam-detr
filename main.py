...
from util.plot import plot_img
...
def get_args_parser():
    ...
    parser.add_argument("--num_classes", type=int, default=1, help="Number of classs")
    ...
    parser.add_argument(
        ...
        default=2048,
        type=int,
        help="dimension of the FFN in the transformer",
    )
    parser.add_argument(
        "--hidden_dim", default=256, type=int, help="dimension of the transformer"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--device",
        default="cuda",
        help="device to use for training / testing. We must use cuda.",
    )
    ...
    parser.add_argument(
        "--eval_every_epoch", default=1, type=int, help="eval every ? epoch"
    )
    parser.add_argument(
        "--save_every_epoch",
        default=1,
    ...
    param_dicts = [
        {
            "params": [
                ...
                if "backbone.0" not in n
                and not match_keywords(n, args.lr_linear_proj_names)
                and p.requires_grad
            ],
            "lr": args.lr,
        },
