...
class FastDETR(nn.Module):
    ...
    def __init__(self, args, backbone, transformer, num_classes):
        ...
        self.num_feature_levels = (
            3 if self.multiscale else 1
        )  # Hard-coded multiscale parameters
    ...
    def forward(self, samples: NestedTensor):
        ...
        hs, reference = self.transformer(
            srcs, masks, self.query_embed.weight, pos_embeds
        )
...
def build(args):
    ...
    num_classes = args.num_classes if args.dataset_file != "coco" else 91
